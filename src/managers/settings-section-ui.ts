...
export type SettingsSection = 'general' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'integrations' | 'templates';
	...
	if (sidebar) {
		sidebar.addEventListener('click', (event) => {
			...
			if (section === 'general'
				...
				|| section === 'reader') {
				showSettingsSection(section as 'general' | 'properties' | 'highlighter' | 'interpreter' | 'integrations' | 'reader');
			}
